...
public class bank {
    public static void main (String args []){
        String str, str1;
        int choice,z,ping=1234,counter=0,a=3;
        int t = 0,s,tab=50000;
                ...
                if (pin==1234)//cek pin
                    do{
                        ...
                        switch (choice){
                            ...
                            case 3:
                            str1 = JOptionPane.showInputDialog(null,"Masukkan jumlah penarikan : " ); //pengambilan t = Integer.parseInt(str1);
                    ...
                    while (1==1);
                else if (counter<3){ //jika pin salah a--; //menghitung kesalahan login dan memberikan kesempatan login
